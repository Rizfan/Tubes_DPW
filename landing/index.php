                    ...
                    ?>
                        <li class="splide__slide mx-2">
                            <div class="splide__slide__container">
                                <a href="detail_produk.php?id=<?= $produk['id_produk'] ?>" class="text-decoration-none text-dark card bg-light">
                                    <img src="../assets/upload/produk/<?= $produk['link_foto_produk'] ?>" class="card-img-top" height="150px" alt="<?= $produk['nama_produk'] ?>">
