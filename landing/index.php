...
require_once __DIR__ . '/../src/proses/proses_session.php';
...
if ($current_session["username"] != null) {
    ...
    ?>
            <a href="./../src/proses/proses_logout.php" class="btn btn-primary my-2-sm-0 mr-3" role="button"
    ...
    ?>
            <a href="./../register.php" class="btn btn-primary my-2-sm-0 mr-3" role="button"
