...
$user = get_user_by_email_password($current_users['email'], $current_users['password']);
?>
                ...
                <div class="card-body">
                    <div class="row  justify-content-center">
                        <div class="col col-md-8">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    <td>Nomor HP</td>
                                    <td>:</td>
                                    <td><?=$user['no_hp']?> <a class="btn btn-primary btn-sm" id="btn_verifikasi_no_hp"
                                            href="#">Verifikasi</a> </td>
                        ...
                        <div class=" col col-md-4">
                            ...
                            <img src="../assets/upload/user/<?=$user['link_foto_user']?>" style="max-width:250px; "
                                alt="<?=$user['nama']?>" class="rounded-circle mb-2">
                            <?php } else {?>
                            <img src="../assets/img/undraw_profile.svg" style="max-width:250px; " class="rounded"
                                alt="<?=$user['nama']?>" class="mb-2">
                            <?php }?>
                            <center>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="#" class="btn btn-primary" data-toggle="modal"
                        data-target="#editModal<?=$penjual['id_penjual']?>">Edit</a>

                    <!-- Modal edit -->
                    <div class="modal fade" id="editModal<?=$penjual['id_penjual']?>" tabindex="-1"
                        aria-labelledby="editModal<?=$penjual['id_penjual']?>" aria-hidden="true">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" class="form-control" id="nama_toko"
                                                name="nama_toko" value="<?=$penjual['nama_toko']?>">
                                        </div>
                                        <div class="form-group">
    ...
    echo "selected";
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="deskripsi_toko" id="deskripsi_toko" class="form-control"
                                                cols="30" rows="5" required><?=$penjual['deskripsi_toko']?></textarea>
                                        </div>
                                    </div>
                ...
                <div class="card-body">
                    ...
                    <!-- Modal Tambah -->
                    <div class="modal fade" id="tambahModal" tabindex="-1" aria-labelledby="tambahModal"
                        aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
