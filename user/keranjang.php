...
<div class="modal fade" id="cekoutModal" tabindex="-1" aria-labelledby="cekoutModal" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="./../src/proses/proses_checkout.php" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="card py-3 px-4">
                        <div class="form-check d-flex align-items-center">
                            ...
                            <label class="form-check-label" for="exampleRadios1">
                                <img src="../assets/img/iconQris-removebg-preview.png" alt="Qris" width="50px;" class="ml-2">
                            </label>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div class="d-flex justify-content-between mb-auto">
                        ...
                        <p class="font-weight-bold" name="total_semua_harga">Rp. <?= number_format($total_semua) ?></p>
                        <input type="hidden" name="total_semua_harga" value="<?= $total_semua ?>">
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <p class="font-weight-bold" name="total_semua_harga">Rp. <?= number_format($total_semua + 1000) ?>
                        </p>
                    </div>
                </div>
