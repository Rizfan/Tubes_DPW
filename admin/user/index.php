...
$get_current_user = session_manager("get_session", ["username", "role", "id_user"]);
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                    data-target="#editModal<?=$user['id_user']?>">Edit</button>
                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                    data-target="#hapusModal<?=$user['id_user']?>">Hapus</button>
                            </td>
                        </tr>
                        <!-- Modal edit -->
                        <div class="modal fade" id="editModal<?=$user['id_user']?>" tabindex="-1"
                            aria-labelledby="editModal<?=$user['id_user']?>" aria-hidden="true">
