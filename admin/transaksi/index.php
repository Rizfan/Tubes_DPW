...
foreach ($trans as $t) {
    ?>
        ...
        if ($t['status_pembayaran'] == "Belum Lunas") {
            ?>
                            ...
                            <?php }?>
                            <td>
                                <a href="detail_transaksi.php?id=<?=$t['id_transaksi']?>"
                                    class="btn my-1 btn-success btn-sm">Detail Transaksi</a>
        ...
        if ($t['status_transaksi'] == "Selesai" || $t['status_transaksi'] == "Batal") {
            ?>
                                    ...
                                    <button class="btn btn-danger btn-sm" type="submit" name="bayar" disabled>Batal
                                        Bayar</button>
                                    <?php } else {
            ?>
                                    <input type="hidden" value="Belum Lunas" name="status">
                                    <button class="btn btn-danger btn-sm" type="submit" name="bayar">Batal
                                        Bayar</button>
                                    <?php
}
    } else {
        if ($t['status_transaksi'] == "Batal") {?>
                                    <input type="hidden" value="Belum Lunas" name="status">
                                    <button class="btn btn-info btn-sm" type="submit" name="bayar"
    ...
    ?>
                        ...
                        <!-- Modal edit -->
                        <div class="modal fade" id="editModal<?=$t['id_transaksi']?>" tabindex="-1"
                            aria-labelledby="editModal<?=$t['id_transaksi']?>" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <form action="#" method="post">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="penjual" name="penjual" required
                                                    disabled>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="number" class="form-control" id="saldo"
                                                        placeholder="Saldo" value="<?=$t['total_harga_pembelian']?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
