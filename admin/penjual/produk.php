...
foreach ($pro as $produk) {
    ?>
                        <tr>
                            ...
                            <td><a href="../../assets/upload/produk/<?=$produk['link_foto_produk']?>"
                                    target="_blank">Lihat Foto</a></td>


                            <td>
                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal"
                                    data-target="#editModal<?=$produk['id_produk']?>">Edit</button>
                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                    data-target="#hapusModal<?=$produk['id_produk']?>">Hapus</button>
                            </td>
                        </tr>
                        <!-- Modal edit -->
                        <div class="modal fade" id="editModal<?=$produk['id_produk']?>" tabindex="-1"
                            aria-labelledby="editModal<?=$produk['id_produk']?>" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
...
$kategori = get_all_kategori();
    foreach ($kategori as $k) {?>
        ...
        echo "selected";
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required type="number" class="form-control"
                                                    value="<?=$produk['stok']?>" id="stok" name="stok">
                                            </div>
                                            <div class="form-group">
        ...
        echo "selected";
                        ...
                        <!-- Modal hapus -->
                        <div class="modal fade" id="hapusModal<?=$produk['id_produk']?>" tabindex="-1" role="dialog"
